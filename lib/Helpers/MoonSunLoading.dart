...
class MoonSunLoading extends StatefulWidget {
  ...
  const MoonSunLoading({super.key, this.isLoading = true});
            ...
            children: [
              ...
              Transform.scale(
                scale:
                    ...
                    (1.3 - _animation.value) *
                        0.12, // subtle scale based on moon animation
                alignment: Alignment.center,
                child: Stack(
                  alignment: Alignment.center,
                  children: [
              ...
              AnimatedBuilder(
                ...
                builder: (context, _) {
                  ...
                  final double opacity =
                      0.18 +
                      0.12 * (0.5 - ((t - 0.5).abs())) * 2; // gentle pulsing
              ...
              Builder(
                builder: (context) {
                  ...
                  final double t = ((_controller.value + 1) / 2.0).clamp(
                    0.0,
                    1.0,
                  );
                  final double scale =
                      1.6 -
                      0.6 *
                          t; // start bigger (zoomed in), then shrink to normal
